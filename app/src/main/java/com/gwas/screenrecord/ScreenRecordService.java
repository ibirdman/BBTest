...
public class ScreenRecordService extends Service {
	...
	private MediaRecorder createMediaRecorder() {
		...
		mediaRecorder.setOutputFile(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES) + "/" + videoQuality + curTime + ".mp4"); // -> /sdcard/Movies/
